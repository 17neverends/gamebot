...
import { getWinMessageTetris, score_text_new, game_name_text, difficulty_ranking_text, difficulty_text,  welcome_text, points_text, empty_leaderboard_text } from "/games/common/localize.js";
...
document.getElementById('scoreText').textContent = `${score_text_new[lang]}: `;
